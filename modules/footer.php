...
<!-- End Wrapper -->
<!-- ============================================================== -->
<script src="<?=$rootURL?>/assets/js/cookies.js"></script>
<script src="<?=$rootURL?>/assets/js/axios.min.js"></script>
<script src="<?=$rootURL?>/assets/node_modules/popper/popper.min.js"></script>
<script src="<?=$rootURL?>/assets/js/moment.js"></script>
<script src="<?=$rootURL?>/assets/js/daterangepicker.min.js"></script>
<script src="<?=$rootURL?>/assets/js/sweetalert2.min.js"></script>
<script src="<?=$rootURL?>/assets/js/jquery.counterup.min.js"></script>
<script src="<?=$rootURL?>/assets/js/jquery.number.min.js"></script>
<script src="<?=$rootURL?>/assets/js/echarts.min.js"></script>
<script src="<?=$rootURL?>/assets/js/chartist.min.js"></script>
<script src="<?=$rootURL?>/assets/js/chartist-plugin-pointlabels.min.js"></script>
<script src="<?=$rootURL?>/assets/js/numeral.min.js"></script>
<script src="<?=$rootURL?>/assets/js/numeral-vi.min.js"></script>
<script src="<?=$rootURL?>/assets/js/jquery.blockUI.js"></script>
<script src="<?=$rootURL?>/assets/js/countrySelect.min.js"></script>
...
<script src="<?=$rootURL?>/dist/js/pages/cla-report/daterange.js"></script>
<script src="<?=$rootURL?>/dist/js/default/alltools.js"></script>
<script src="<?=$rootURL?>/dist/js/default/header.js?v=1.0"></script>
<script src="<?=$rootURL?>/dist/js/pages/date.format.js"></script>
<script src="<?=$rootURL?>/dist/dist/js/pages/bendmarks/scrolltop.js"></script>

<!-- <script src="<?=$rootURL?>/dist/js/default/custom-page.js"></script> -->

<script src="<?=$rootURL?>/dist/js/jquery.toast.js"></script>
<script src="<?=$rootURL?>/dist/js/swiper.min.js"></script>
<script src="<?=$rootURL?>/dist/js/swiper.js"></script>
