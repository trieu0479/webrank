<div class="text-center mt-5 mb-0">
    <div class="input-group keywordSearchBox">
        ...
        <input type="text" class="form-control ml-1 font-14  iptKeyword" aria-label="Mỗi từ khóa cách nhau bởi đấu ," value="<?=$_GET['keywords']?>" placeholder="Mỗi từ khóa cách nhau bởi đấu ," >
        <select class="border selectpicker selectNetwork ml-1 ">
