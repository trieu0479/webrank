<div class="full-page">
    <div class="page-wrapper">
        ...
        <div class="container BendmarksTool" id="export">
                                ...
                                <div class="information-wrapper d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="dropdown-wrapper">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a class="dropdown-item" id="export-pdf"><i
                                            ...
                                            <a class="dropdown-item" id="addMetric" href="javascripvoild:0"><i
            ...
            <div class="page-content pt-4 pb-5" style="margin: 0 -10px !important;">
...
<script type="module" src="dist/dist/js/pages/report/show_compare.js?<?=$version?>"></script>
