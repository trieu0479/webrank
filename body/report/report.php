<div class="page-wrapper">
    ...
    <div class="container BendmarksTool" id="export">
                                ...
                                <div class="slect-custom d-flex align-items-center">
                                    <div class="logo p-2 d-flex justify-content-center align-items-center" style="text-align: center;">
                                        <div class="avatar-preview"> 
                                            <div id="imagePreviewContactForm" data-url="http://localhost/assets/images/logo_admin.png" style="background-image: url(http://localhost/assets/images/logo_admin.png);"></div> 
                                        </div>
                                    </div>
                                    <div id="custom_slect">
        ...
        <div class="page-content pt-5" style="margin: 0 -10px !important;">
...
<script type="module" src="dist/dist/js/pages/report/show_report.js?<?=$version?>"></script>
<script src="dist/dist/js/pages/bendmarks/scrolltop.js"></script>
<script src="dist/dist/js/pages/bendmarks/scrolltop.js"></script>
<script src="dist/js/pages/report/infused.js"></script>
<script>
