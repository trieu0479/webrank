...
<script type="module" src="dist/js/pages/website/overview/index.js?v=<?=$version?>"></script>
<script type="module" src="dist/js/pages/website/overview/tableFunction.js?v=<?=$version?>"></script>
