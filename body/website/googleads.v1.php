...
<div class="page-wrapper">
        ...
        <div class="page-content pt-5">
            ...
            <div class="bg-white rounded p-3 mt-3 mt-3">
                <ul class="nav nav-tabs nav-keyplanner" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active" id="googleads"  href="./index.php?view=website&action=gg-ads&domain=<?= $_GET['domain'] ?>&language=vn&country=vn" role="tab" aria-controls="contact" aria-selected="false"><i class="fal fa-audio-description font-14 text-warning mr-2"></i>Google Ads</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="displayads"  href="./index.php?view=website&action=display-ads&domain=<?= $_GET['domain'] ?>&language=vn&country=vn" role="tab" aria-controls="contact" aria-selected="false">Display Ads</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="similarBody ">
                ...
                <div class="row mt-3 p-10">
                    <div class="col-12 col-lg-12 mb-1">
                        <div class="bg-white shadow-sm rounded" style="height:309px">
                            ...
                            <div class=" row border-bottom m-0 py-2">
                                ...
                                <div class="col-auto pl-0">
                                    <div class="text-capitalize font-weight-bold"><?= _("Overview GoogleAds") ?></div>
                            ...
                            <div class="rank-displayads bg-white mt-4 rounded d-flex flex-row w-100 justify-content-center">
                                <div class=" mr-3 mt-4 ml-2 d-flex no-block align-items-center justify-content-center flex-column bg-white rounded shadow h-100 py-4 py-md-5  " style="width: 30%!important">
                                    <div class="rank-title d-flex justify-content-center flex-row pl-3">
                                        <span class="font-14 font-weight-400 d-flex flex-row ">Keywords</span>
                                    ...
                                    <div class="rank-value pt-3 font-weight-bold ">
                                        <a href="#">
                                            <span style="font-size:30px" class="font-weight-bold kwhard  "></span>
                                        </a>
                                        <span class="text-danger ml-1 font-14 cl-kw"></span>
                                    </div>

                                </div>
                                <div class="mr-3 mt-4 ml-2 d-flex no-block align-items-center justify-content-center flex-column bg-white rounded shadow h-100 py-4 py-md-5  " style="width: 30%!important">
                                    <div class="rank-title d-flex justify-content-center flex-row">
                                        <span class="font-14 font-weight-400 d-flex flex-row ">Traffic</span>
                                    ...
                                    <div class="rank-value pt-3 font-weight-bold">
                                        <a href="#">
                                            <span style="font-size:30px" class="font-weight-bold visit"></span>
                                        </a>
                                        <span class="text-danger ml-1 font-14 cl-tf"></span>
                                    </div>

                                </div>
                                <div class=" mr-3 mt-4 ml-2 d-flex no-block align-items-center justify-content-center flex-column bg-white rounded shadow h-100 py-4 py-md-5  " style="width:30%!important">
                                    <div class="rank-title d-flex justify-content-center flex-row">
                                        <span class="font-14 font-weight-400 d-flex flex-row ">Traffic Cost</span>
                                    ...
                                    <div class="rank-value pt-3 font-weight-bold ">
                                        <a href="#">
                                            <span style="font-size:30px" class="font-weight-bold t_seen  tra-cost"></span>
                                        </a>
                                        <span class="text-danger ml-1 font-14 cl-tfc"></span>
                                    </div>
                    ...
                    <div class="col-12 col-lg-12 mb-4">
                        <div class="bg-white shadow-sm rounded">
                            <div class="row m-0 pt-2 mb-2">
                                ...
                                <div class="col-auto pl-0">
                                    <div class="text-capitalize font-weight-bold"><?= _("Paid Search Trend") ?>
                                    </div>
                                    <div class="text-muted similarDates font-10"></div>
                                </div>
                            </div>
                            <div id="myTabContent" class="rounded is-loading" style="min-height:400px">
                                <ul class="nav nav-tabs customtab" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" data-task="EstimateChart" href="#EstimateChart" role="tab"> <span class=""><i class="far fa-calendar-week fa-lg"></i></span> <span class="d-none d-md-inline">Estimated Traffic</span></a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" data-task="KeywordsChart" href="#KeywordsChart" role="tab"> <span class=""><i class="far fa-clipboard-user fa-lg"></i></span> <span class="d-none d-md-inline">Keywords</span></a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" data-task="CostChart" href="#CostChart" role="tab"> <span class=""><i class="far fa-stopwatch fa-lg"></i></span> <span class="d-none d-md-inline">Traffic Cost</span></a>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="row">
                                    <div class="col-12 col-md-12 tab-content mt-1 mt-md-3">
                                        <div class="tab-pane px-4 active" id="EstimateChart" role="tabpanel" style="height: 300px"></div>
                                        <div class="tab-pane px-4 " id="KeywordsChart" role="tabpanel" style="height:300px"></div>
                                        <div class="tab-pane px-4" id="CostChart" role="tabpanel" style="height:300px"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!--------------------------------------- ----------------------------------topkeywords and paid---------------------- -->
                    ...
                    <div class="col-12 col-lg-6 mb-5">
                        <div class="bg-white shadow-sm rounded">
                            <div class="row border-bottom m-0 py-2">
                                ...
                                <div class="col-auto pl-0">
                                    <div class="text-capitalize font-weight-bold"><?= _("Top Paid Keywords") ?></div>
                                    <div class="text-muted similarDates font-10"></div>
                                </div>
                                <div class="ml-auto d-flex no-block align-items-center pr-3">
                                    <a class="similarReloadTask text-muted" data-task="getWebDemographicsAge" href="javascript:;"><i class="fal fa-sync"></i></a>
                            ...
                            <div class="mt-3">
                                <div class="list-public  d-flex flex-column" style="min-height: 320px">
                                    <div class="row-public-header d-flex">
                                        <div class="left-public d-flex align-items-center h-100">
                                            <div class="category-pb font-12 line-height-18">Keywords</div>
                                        </div>
                                        <div class="all-right">
                                            <div class="right-paid">
                                                <div class="percent">Position</div>

                                            </div>
                                            <div class="right-paid">
                                                <div class="percent">Volume</div>

                                            </div>
                                            <div class="right-paid">
                                                <div class="percent">CPC&nbsp;(USD)</div>

                                            </div>
                                            <div class="right-paid">
                                                <div class="percent">Traffic %</div>
                                                <span class="mation">
                                                    <svg style="fill:#64787e" class="_icon_1fpvc_1" data-name="SortDesc" data-group="xs" width="12" height="12" viewBox="0 0 12 12">
                                                        <path d="M1 3v-2h10v2h-10zm0 4v-2.001h6v2.001h-6zm0 4v-2h3v2h-3z" shape-rendering="geometricPrecision"></path>
                                                    </svg>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <!-- ------------body---- -->
                                    <div class="" id="push_paid_key">                                     
                                    </div>

                                    <div class="footer-view-kw mt-4  pt-3 ml-4">
                                        <a href="#">
                                            <button class="btn btn-primary btn-sm" style="padding: 4px 13px;">
                                                <span class="content-btn">View full report</span>
                                            </button>
                                        </a>
                                    </div>
                    ...
                    <div class="col-12 col-lg-6 mb-5">
                        <div class="bg-white shadow-sm rounded Ads-Type">
                            <div class="row border-bottom m-0 py-2">
                                ...
                                <div class="col-auto pl-0">
                                    <div class="text-capitalize font-weight-bold"><?= _("Paid Position Distribution") ?></div>
                                    <div class="text-muted similarDates font-10"></div>
                                </div>
                                <div class="ml-auto d-flex no-block align-items-center pr-3">
                                    <a class="similarReloadTask text-muted" data-task="getWebDemographicsAge" href="javascript:;"><i class="fal fa-sync"></i></a>
                            ...
                            <div class="mt-3">
                                   <div class="Parrent--PositionChart" style="min-height:320px">
                                   <div id="PositionChart" class="w-100 rounded is-loading" style="height:400px"></div>
                                   </div>            
        ...
        <!----------------------------------- -------------------------------- main paid and ----competitive position -->
        <div class="row mt-3">
                    <div class="col-12 col-lg-6 mb-5">
                        <div class="bg-white shadow-sm rounded">
                            <div class="row border-bottom m-0 py-2">
                                ...
                                <div class="col-auto pl-0">
                                    <div class="text-capitalize font-weight-bold"><?= _("Main Paid Competitors") ?></div>
                                    <div class="text-muted similarDates font-10"></div>
                                </div>
                                <div class="ml-auto d-flex no-block align-items-center pr-3">
                                    <a class="similarReloadTask text-muted" data-task="getWebDemographicsAge" href="javascript:;"><i class="fal fa-sync"></i></a>
                            ...
                            <div class="mt-3">
                                <div class="list-public  d-flex flex-column" style="min-height: 320px">
                                    <div class="row-public-header d-flex">
                                        <div class="left-public d-flex align-items-center h-100">
                                            <div class="category-pb font-12 line-height-18">Competitor</div>
                                        </div>
                                        <div class="all-right">
                                            <div class="right-competitor">
                                                <div class="percented">Com.Level</div>
                                                <span class="mation">
                                                    <svg style="fill:#64787e" class="_icon_1fpvc_1" data-name="SortDesc" data-group="xs" width="12" height="12" viewBox="0 0 12 12">
                                                        <path d="M1 3v-2h10v2h-10zm0 4v-2.001h6v2.001h-6zm0 4v-2h3v2h-3z" shape-rendering="geometricPrecision"></path>
                                                    </svg>
                                            ...
                                            <div class="right-competitor">
                                                <div class="percented">Com.Keywords</div>

                                            </div>
                                            <div class="right-competitor">
                                                <div class="percented">Paid Keywords</div>
                                    ...
                                    <!-- ------------body---- -->
                                    <div class="" id="push_main_competitor">                                     
                                    </div>
                    ...
                    <div class="col-12 col-lg-6 mb-5">
                        <div class="bg-white shadow-sm rounded Ads-Type">
                            <div class="row border-bottom m-0 py-2">
                                ...
                                <div class="col-auto pl-0">
                                    <div class="text-capitalize font-weight-bold"><?= _("Competitive Positioning Map") ?></div>
                                    <div class="text-muted similarDates font-10"></div>
                                </div>
                                <div class="ml-auto d-flex no-block align-items-center pr-3">
                                    <a class="similarReloadTask text-muted" data-task="getWebDemographicsAge" href="javascript:;"><i class="fal fa-sync"></i></a>
                            ...
                            <div class="mt-3">
                                   <div class="Parrent--CompetitorMapChart" style="min-height:320px">
                                   <div id="CompetitorMapChart" class="w-100 rounded is-loading" style="height:400px"></div>
                                   </div>            
...
<script src="dist/js/pages/website/ggads-display/gg-ads.js"></script>
<!--
