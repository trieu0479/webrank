<div class="bg-white shadow-sm rounded">
    <div class="row border-bottom m-0 py-2">
        ...
        <div class="ml-auto d-flex no-block align-items-center pr-3">
            <a class="similarReloadTask text-muted" data-task="topPublicSher" href="javascript:;"><i
    ...
    <div class="mt-3 parent-topPublicSher" id="Parent-topPublicSher">
        <div class="list-public  d-flex flex-column" style="min-height: 260px">
                ...
                <div class="right-public">
                    ...
                    <span class="mation">
                        <svg fill="currentColor" preserveAspectRatio="xMidYMid meet"
                            class="sc-1_4_12-icon -Styles-info-icon-3r4P4j-" viewBox="0 0 12 12" width="12" height="12"
                            data-name="InfoChar" data-group="xs">
                            <path
                                d="M7.5 4a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm.158 2.862L6.71 10.67H9V12H5.797a1.499 1.499 0 0 1-1.455-1.863l.95-3.807H3V5h3.203c.976 0 1.691.916 1.455 1.862z"
            ...
            <div class="row"  id="topPublishersCategories">
