...
<script type="module" src="dist/js/pages/website/displayads/index.js?v=<?= $version ?>"></script>
<script type="module" src="dist/js/pages/website/displayads/callechartFunction.js?v=<?= $version ?>"></script>