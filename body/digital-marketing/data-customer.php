                        ...
                        <div class="bg-white px-3 py-5 rounded shadow-sm">
                            <div class="mb-5">
                                ...
                                <div class="mt-1 font-gg font-weight-500 font-14 text-muted">
                                    Sau khi quảng cáo và nâng cấp website, bạn sẽ có nhiều khách hàng liên lạc. Ứng dụng FFF trên điện thoại sẽ giúp bạn quản lý khách hàng thuận tiện hơn.
                                </div>
                            </div> 
                            ...
                            <div class="mb-4 bg-dark-2 px-3 py-2 text-left">
                                <div class="font-gg font-weight-500 font-14">FFF App là ứng dụng dùng trên di động, giúp bạn theo dõi và quản lý khách hàng mọi lúc mọi nơi.</div>
                            </div>
                            <div class="">
...
<script src="<?=$rootURL?>/dist/js/pages/digital-marketing/data-customer.js"></script>  