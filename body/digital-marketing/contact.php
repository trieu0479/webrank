                        ...
                        <div class="bg-white px-3 py-5 rounded shadow-sm">
                            <div class="mb-5">
                                ...
                                <div class="mt-1 font-gg font-weight-500 font-14 text-muted">
                                    Vui lòng bổ xung thông tin để tiếp tục
                                </div>
                            </div> 
                            <div class="mb-5"> 
                                <div class="text-left d-flex no-block flex-column mb-4">
                                    <div class="align-self-center font-gg font-weight-bold mb-2 font-13 w-100">Tên liên hệ</div>
                                    <input id="input-name" value="" type="text" class="font-13 text-muted form-control" placeholder="Nhập tên liên hệ">
                                </div> 
                                <div class="text-left d-flex no-block flex-column mb-4">
                                ...
                                <div class="text-left d-flex no-block flex-column">
                                    ...
                                    <input id="input-email" value="" type="text" class="font-13 text-muted form-control" placeholder="Nhập email">
                                </div> 
                            </div>
                            <div class="text-right">
                                <button class="btn-next btn btn-info font-gg font-15 font-weight-500 px-5">Tiếp tục</button>
                            </div>
                        </div>
                    </div>
                </div> 
