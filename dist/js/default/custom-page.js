...
//                               a 15.9155 15.9155 0 0 1 0 31.831
//                               a 15.9155 15.9155 0 0 1 0 -31.831" />
//                           <text x="50%" y="63%" class="percentage ${number}">${performance}</text>
//                       </svg>
//                  </div> `;
...
//       if (width >= 100) {
//         clearInterval(id);
//         // if(typeof bla.data.pageSpeed =='undefined'){
//         //     return alert('Mời thử lại!');
//         // }else{
//         $('.progresss').addClass('display-none');
...
//     $('.title-main').addClass('display-none');
//     // $('.SiteWeb').addClass('display-none');
//     sessionStorage.setItem('checkPoint', 'Desktop');
//     var domain = $('#websiteUrl').val().toLowerCase();
//     domain = domain.replace('', 'https://');
//     var domainweb = $('#websiteUrl').val()
//     if(domainweb === ''){
...
//     if (domain === '') {
//       return alert('Mời bạn nhập website');
//     } else {
//       $('.main').addClass('display-none');
//       $('.tab-action').addClass('display-none');
//       $('.progresss').removeClass('display-none');
//       move();
//       var getSiteWeb = "//localapi.trazk.com/webdata/websiteapi.php?task=getLastAnalysisTable&limit=30&domain=" + domainweb;
//       // console.log(getSiteWeb)
//       var url = "//localapi.trazk.com/pagespeed/index.php?task=getWebsitePageSpeed&userToken=cHhZeE1KcFQvSis0K2VrN3kxMm1oQT09OjpxzF1Po19uXTHZBqnUT9hb&url=" + domain;
//       var urlMoblie = "//localapi.trazk.com/pagespeed/index.php?task=getWebsitePageSpeedMobile&userToken=cHhZeE1KcFQvSis0K2VrN3kxMm1oQT09OjpxzF1Po19uXTHZBqnUT9hb&url=" + domain;
//       $.getJSON(getSiteWeb, function (res) {
...
//           web += `
//             <div class="changeURL">
//               <a href="?websiteUrl=${website[x].Domain}&view=pagespeed&action=result">
//                   <div class="img">
//                       <img src="${website[x].Favicon} " alt="">
//                   </div>
//                   <p>${website[x].Domain}</p>
//               </a>
//             </div>
//           `
...
//     sessionStorage.setItem('checkPoint', 'Moblie');
//     $('.desktop-img').addClass('css-img');
//     SpeedWeb(JSON.parse(sessionStorage.resMoblie));
//   });


//   $('.desktop').click(function () {
//     sessionStorage.setItem('checkPoint', 'Desktop');
//     $('.desktop-img').removeClass('css-img');
//     SpeedWeb(JSON.parse(sessionStorage.resDesktop));
//   })
...
//       } else {
//         SpeedWeb(JSON.parse(sessionStorage.resDesktop));
//         console.log(JSON.parse(sessionStorage.resDesktop)); 
//         cc++;
//       }
//     }
