    ...
    if (res != null) {
      ...
      let html = `
        <div class="imgPageAds d-flex align-items-end"
          style="--cover-photo-uri: url('${res.data.pageCoverPhoto}');background-size: cover;height: 100%;width: 100%;background-position: center;background-repeat: no-repeat;background-image:linear-gradient(rgba(0, 0, 0, .1), rgba(0, 0, 0, .8)), var(--cover-photo-uri);padding: 20px!important;">
