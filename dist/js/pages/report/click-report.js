$(window).on('load',(event)=>{
    ...
    function show__toastrerror() {
        Command: toastr["error"]("Lưu thất bại")
  ...
  "hideMethod": "fadeOut"
    ...
    $('body').on('click', '#saveLink', ()=> {  
        ...
        $(".grid-stack-item").each(function( index ) {
            ...
            console.log('post task',post.task);            
        ...
        $.post(`//localapi.trazk.com/report/index.php?task=saveReport&userToken=${userToken}`, posts,function(res){
            console.log(res);
            console.log(res.data);
            var parse = JSON.parse(res);
           if (parse.data.status == "Exist") {
            show__toastrerror();
           }
           else {
          show_toastr_success();
