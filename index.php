...
switch ($action) {
    ...
    case "overview": 
        $data = file_get_contents("https://localapi.trazk.com/webdata/websiteapi.php?task=getHeader&domain=".$_GET['domain']."&userToken=".$userToken);
        ...
        $data = file_get_contents("https://localapi.trazk.com/webdata/websiteapi.php?task=estmatedWorth&domain=".$_GET['domain']."&userToken=".$userToken);
        $data = json_decode($data,true);
